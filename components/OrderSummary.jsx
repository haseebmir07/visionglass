...
// import axios from "axios"; // You also missed importing axios!
...
//           setSelectedAddress(data.addresses[0]); // Set the first address as the default
//         } else {
  ...
  return (
    <div className="w-full md:w-96 bg-gray-100 p-5">
      ...
      <button
        onClick={createOrder}
        disabled={loading}
        className={`w-full mt-6 py-3 text-white transition
          ${loading
            ? "bg-gray-400"
